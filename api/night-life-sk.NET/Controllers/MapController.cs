...
namespace night_life_sk.Controllers
{
    ...
    internal class MapController : Controller
    {
        ...
        internal IActionResult GetAllPlaces() => Ok(mapService.GetAllPartyPlaces());

        [HttpGet("/place-on-click")]
        [ProducesResponseType(200, Type = typeof(PlaceAndEventDto))]
        internal IActionResult GetPlaceAndEventOnClick (
        ...
        internal IActionResult GetAllEventsByDate(DateTime date)
        {
        ...
        [ProducesResponseType(200, Type = typeof(HashSet<PartyEventDto>))]
        internal IActionResult GetFilteredEvents([FromQuery] FilteredEventsDto filteredParam)
        {
        ...
        internal IActionResult GetInterestedUsersForEvent(string eventName)
        {
